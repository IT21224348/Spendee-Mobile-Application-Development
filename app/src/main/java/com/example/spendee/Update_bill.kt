...
import com.example.spendee.databinding.ActivityUpdateBillsBinding

class Update_bill : AppCompatActivity() {
    private lateinit var binding: ActivityUpdateBillsBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        //Initialize the binding
        binding = ActivityUpdateBillsBinding.inflate(layoutInflater)
