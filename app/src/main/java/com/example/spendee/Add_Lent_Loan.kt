...
import com.example.spendee.databinding.ActivityAddLentLoanBinding
import com.google.firebase.auth.FirebaseAuth
import com.google.firebase.database.DatabaseReference
import com.google.firebase.database.FirebaseDatabase
import java.util.*

class Add_Lent_Loan : AppCompatActivity() {

    var nodeId = ""
     private lateinit var binding:ActivityAddLentLoanBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityAddLentLoanBinding.inflate(layoutInflater)
       ...
       //Set up navigation bar
        ...
        binding.AddLoan.setOnClickListener {
            if (checkAllfields()) {
                ...
                val borrowed_loan =
                    Lented_loan(BorrowedName, BorrowedAmount, BorrowedDate, SettleDate)
    ...
    fun showlist(view: View) {
        var i: Intent
        i = Intent(this, View_lent_loan::class.java)
