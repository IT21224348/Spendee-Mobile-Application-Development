...
@LargeTest
class Add_incomeTest {

    private lateinit var scenario: ActivityScenario<*>

    @Before
    fun setup() {
        scenario = ActivityScenario.launch(Add_income::class.java)
    ...
    fun testaddincome() {
        ...
        Espresso.onView(ViewMatchers.withId(R.id.loanDate1)).perform(ViewActions.typeText(date))

        Espresso.closeSoftKeyboard()

        // Wait for the 'loanSettle' view to be displayed before clicking
